Please check if what you want to add to `go-zilionixx` list meets [quality standards](https://github.com/zilionixx/go-zilionixx/blob/master/CONTRIBUTING.md#quality-standard) before sending pull request.
