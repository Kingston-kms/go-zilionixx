...
opera:
	...
	go build \
	    -ldflags "-s -w -X github.com/Fantom-foundation/go-zilionixx/cmd/opera/launcher.gitCommit=$${GIT_COMMIT} -X github.com/Fantom-foundation/go-zilionixx/cmd/opera/launcher.gitDate=$${GIT_DATE}" \
	    -o build/opera \
	    ./cmd/opera
