...
func (t TestBackend) GetRules() zilionixx.Rules {
	return t.rules
}

func (t TestBackend) GetPendingRules() zilionixx.Rules {
...
func TestSuggestPrice(t *testing.T) {
	backend := &TestBackend{
		block:             1,
		totalGasPowerLeft: 0,
		rules:             zilionixx.FakeNetRules(),
		pendingRules:      zilionixx.FakeNetRules(),
	}
