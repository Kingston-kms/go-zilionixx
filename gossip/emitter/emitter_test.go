...
import (
	...
	"github.com/Fantom-foundation/go-zilionixx/gossip/emitter/mock"
...
//go:generate go run github.com/golang/mock/mockgen -package=mock -destination=mock/world.go github.com/Fantom-foundation/go-zilionixx/gossip/emitter External,TxPool,TxSigner,Signer
